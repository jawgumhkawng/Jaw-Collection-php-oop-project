              ...
              <div class="row">
                ...
                <div class="col-md-6 ">
                  <div class="right-image shadow-lg" style="border: 2px solid gray; border-radius: 10px;" >
                    <img src="assets/images/feature-image.jpg" alt="" style="border-radius: 8px;">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="left-content">
                    ...
                    <p class="mb-5">Lorem ipsum dolor sit amet, consectetur Lorem ipsum dolor sit amet, consectetur Lorem ipsum dolor  sit amet, consectetur </p>
                    ...
                    <a href="#" class="btn btn-outline-primary float-right shadow">CheckOut</a>
                  </div>
                </div>
              </div>
            </div>
