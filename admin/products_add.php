        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="contact-form">
              <form id="contact" action="../_actions/prd_add.php" method="post" enctype="multipart/form-data">
                <div class="row">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="image" type="file" class="form-control"  placeholder="Product Image" required="">
                    </fieldset>
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
