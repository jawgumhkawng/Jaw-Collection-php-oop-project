      ...
      <div class="owl-banner owl-carousel">
        <div class="banner-item-01">
          <div class="text-content">
            ...
            <br>
            <h6 class="text-secondary">Home Page</h6>
          </div>
        </div>
...
<!-- 
    <div class="footer-fixed d-none animate__animated float-right">
      <div class="footer-icon rounded-5 d-flex justify-content-center align-items-center bg-primary shadow-blue-600 shadow-lg">
        <a href="#home" class="" ><i class="fas fa-angle-up text-white scroll"></i></a>
      </div>
    </div> -->
